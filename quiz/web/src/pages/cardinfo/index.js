        ...
        <div id='CardInfo'>
            ...
            <section className='CardInfo'>
                ...
                <div className='Info'>
                    ...
                    <>
                    <h1>Dica</h1>
                    <p>No quiz do Frei, os jogadores têm a opção de ganhar uma dica para cada pergunta, mas cada ação só pode ser usada uma vez. Isso adiciona uma dimensão estratégica ao jogo, pois os jogadores precisam escolher sabiamente quando usar essa vantagem.</p>
                    </>
                    }
